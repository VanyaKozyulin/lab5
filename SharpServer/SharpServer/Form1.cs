...
namespace UdpServer
{
    ...
    public partial class ServerForm : Form
    {
        ...
        private void DrawText(string parameters)
        {
            ...
            if (paramParts.Length == 4)
            {
                    ...
                    int.TryParse(paramParts[1].Trim(), out y0))
                {
                    ...
                    text = paramParts[3].Trim();
                    Color color = ParseColor(colorName);

                    DrawTextOnForm(x0, y0, color, text);

                    lblCommand.Text = $"Команда: draw text";
                    lblParam.Text = $"Параметры: x0={x0}, y0={y0}, color={colorName}, text={text}";
                }
                else
                {
        ...
        private void DrawTextOnForm(int x0, int y0, Color color, string text)
        {
            using (Graphics g = CreateGraphics())
            {
                using (Pen pen = new Pen(color))
                {
                    ...
                    foreach (char letter in text.ToLower())
                    {
                        ...
                        {
                            case 'a':
                                g.DrawLine(pen, x0+25, y0-40, x0 + 25, y0);
                                g.DrawLine(pen, x0, y0, x0 + 25, y0-40);
                                g.DrawLine(pen, x0 + 7, y0 - 10, x0 + 23, y0 - 10);
                                x0 += 30;
                                break;

                            case 'b':
                                g.DrawLine(pen, x0, y0, x0, y0 - 40);

                                g.DrawLine(pen, x0, y0, x0 + 20, y0);
                                g.DrawLine(pen, x0, y0 - 40, x0 + 10, y0 - 40);
                                g.DrawLine(pen, x0+10, y0- 40 , x0 + 20 , y0 - 28 );
                                g.DrawLine(pen, x0 + 20, y0 - 28, x0 + 20, y0 - 20);
                                g.DrawLine(pen, x0 + 20, y0 - 20, x0, y0 - 20);
                                g.DrawLine(pen, x0 + 20, y0 - 20, x0 + 25, y0 - 15);
                                g.DrawLine(pen, x0 + 25, y0, x0 + 25, y0 - 15);
                                g.DrawLine(pen, x0+25, y0, x0, y0);
                            ...
                            case 'c':
                                ...
                                g.DrawLine(pen, x0, y0, x0, y0 - 40);
                                g.DrawLine(pen, x0 + 25, y0, x0, y0);
                                g.DrawLine(pen, x0 , y0-40, x0 + 25, y0-40);
                            ...
                            case 'l':
                                g.DrawLine(pen, x0, y0, x0, y0 - 40);
                                g.DrawLine(pen, x0, y0 , x0 + 25, y0);
                                x0 += 30; 
                                break;

                            case '5':
                                g.DrawLine(pen, x0, y0-40, x0+25, y0 - 40);
                                g.DrawLine(pen, x0, y0 - 40, x0, y0 - 20);
                                g.DrawLine(pen, x0, y0 - 20, x0 + 25, y0 - 20);
                                g.DrawLine(pen, x0 + 25, y0, x0 + 25, y0 - 20);
                                g.DrawLine(pen, x0, y0, x0+25, y0);
                                x0 += 30; 
                                break;
                            case '_':
